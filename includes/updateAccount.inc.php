    ...
    */
    ...
    if(empty($errors)) {
        ...
        if(!empty($newPassword) && !empty($confirmNewPassword)){
            $sql = "UPDATE user SET FullName='$fullName', Email='$email', Password='$hashedNewPassword' WHERE UserID='$current_user_id'";
        ...
        // keep password (NewPassword & ConfirmNewPassword is left blank)
            ...
            $sql = "UPDATE user SET FullName='$fullName', Email='$email' WHERE UserID='$current_user_id'";
