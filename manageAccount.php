                ...
                <div class="row gutters">
                  ...
                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="form-group">
                      ...
                      <input 
                        type="text" class="form-control" id="bio" name="bio" placeholder="Enter your biography" 
                ...
                <div class="row gutters">
                  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 pt-2">
                    <div class="text-right">
                      <button type="button" id="submitinfo" name="submit" class="btn btn-primary">Update Personal Details</button>
                    </div>
                  </div>
                </div>
